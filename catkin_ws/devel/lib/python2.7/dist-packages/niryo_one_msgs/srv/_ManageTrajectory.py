...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.trajectory.trajectory_plan.trajectory_start.joint_state.position))
      length = len(self.trajectory.trajectory_plan.trajectory_start.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.trajectory.trajectory_plan.trajectory_start.joint_state.velocity))
      length = len(self.trajectory.trajectory_plan.trajectory_start.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.trajectory.trajectory_plan.trajectory_start.joint_state.effort))
      _x = self
      ...
      buff.write(_get_struct_B().pack(self.trajectory.trajectory_plan.trajectory_start.is_diff))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.trajectory.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.trajectory.description = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.trajectory.trajectory_plan.trajectory_start.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.trajectory.trajectory_plan.trajectory_start.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory.trajectory_plan.trajectory_start.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory.trajectory_plan.trajectory_start.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.trajectory.trajectory_plan.trajectory_start.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.trajectory.trajectory_plan.group_name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.trajectory.trajectory_plan.trajectory.joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.trajectory.trajectory_plan.trajectory.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.trajectory.id))
      _x = self.trajectory.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      for val1 in self.trajectory.trajectory_plan.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v119.plane_poses:
          ...
          _x = _v128
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v119.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
    ...
    try:
      ...
      for val1 in self.trajectory.trajectory_plan.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v175.plane_poses:
          ...
          _x = _v184
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v175.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v203.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v206.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v206.db = str[start:end].decode('utf-8')
        else:
