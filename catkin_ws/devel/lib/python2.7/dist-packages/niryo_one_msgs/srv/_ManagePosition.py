...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.position.joints))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.position_name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.position.name = str[start:end].decode('utf-8')
      else:
      ...
      self.position.joints = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 80
