...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.sequence.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.sequence.description = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.sequence.blockly_xml = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.sequence.python_code = str[start:end].decode('utf-8')
      else:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.sequence.id))
      _x = self.sequence.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
