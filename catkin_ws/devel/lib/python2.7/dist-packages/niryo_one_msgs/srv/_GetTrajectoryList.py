      ...
      for val1 in self.trajectories:
        ...
        for val4 in _v2.attached_collision_objects:
          ...
          for val6 in _v15.plane_poses:
            ...
            _x = _v24
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v15.operation))
        ...
        buff.write(_get_struct_B().pack(_v2.is_diff))
        _x = _v1.group_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v46.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v46.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v46.effort = struct.unpack(pattern, str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v58.id = str[start:end].decode('utf-8')
          else:
        ...
        if python3:
          _v44.group_name = str[start:end].decode('utf-8')
        else:
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.trajectories:
        ...
        _v93 = _v92.header
        buff.write(_get_struct_I().pack(_v93.seq))
        _v94 = _v93.stamp
        _x = _v94
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v93.frame_id
        ...
        for val4 in _v88.attached_collision_objects:
          ...
          _v112 = _v111.header
          buff.write(_get_struct_I().pack(_v112.seq))
          _v113 = _v112.stamp
          _x = _v113
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v112.frame_id
          ...
          for val6 in _v111.points:
            ...
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
          buff.write(_get_struct_d().pack(val4.weight))
        buff.write(_get_struct_B().pack(_v88.is_diff))
        _x = _v87.group_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v144.id = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v147.key = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v147.db = str[start:end].decode('utf-8')
          else:
        ...
        if python3:
          _v130.group_name = str[start:end].decode('utf-8')
        else:
