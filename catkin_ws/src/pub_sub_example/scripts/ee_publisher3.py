...
class TrajectoryPublisher(object):
    ...
    def __init__(self):
        ...
        self.gripper_poses = [Pose(Point(-0.004275, 0.77625, 0.61161), Quaternion(-0.43248, -0.70685, 0.14185, 0.54149)),
                              Pose(Point(0.533, 0.0, 0.889), Quaternion(0, 0.707, 0, 0.707))]
